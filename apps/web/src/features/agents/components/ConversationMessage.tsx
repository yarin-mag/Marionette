            ...
            return (
              <div className={cn(
                ...
                >
                  ...
                  {tooltip === 'input' && (
                    <span className="absolute top-full left-0 mt-2 w-48 rounded-md bg-popover border border-border px-2.5 py-1.5 text-[11px] leading-snug text-popover-foreground shadow-md z-50 whitespace-normal">
                ...
                {showSystemHint && (
                  ...
                  >
                    ...
                    {tooltip === 'hint' && (
                      <span className="absolute top-full right-0 mt-2 w-56 rounded-md bg-popover border border-border px-2.5 py-1.5 text-[11px] leading-snug text-popover-foreground shadow-md z-50 whitespace-normal">
