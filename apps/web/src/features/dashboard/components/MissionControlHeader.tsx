...
const DISCORD_URL = "https://discord.gg/rA9ySmr3";
    ...
    <div className="relative overflow-hidden rounded-2xl border border-border bg-card">
      ...
      <div className="relative flex items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-4">
          <img
            src="/marionette-icon-64.svg"
            alt="Marionette"
            className="h-12 w-12 flex-shrink-0 rounded-xl shadow-lg shadow-primary/40"
          />
        ...
        <div className="flex items-center gap-2">
          ...
          {disconnectedCount > 0 && (
            ...
            >
              {hideDisconnected ? (
                <><Eye className="mr-1.5 h-4 w-4" />Show {disconnectedCount} offline</>
              ) : (
                <><EyeOff className="mr-1.5 h-4 w-4" />Hide {disconnectedCount} offline</>
              )}
            </Button>
          )}
          {agentCount > 0 && (
